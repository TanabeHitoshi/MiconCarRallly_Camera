...
int lcdProcess( void )
{
    ...
    if( getSwFlag(SW_3) ) {
		...
		lcdPrintf( "                ", i );
		lcdPrintf( "                ", i );
        if( lcd_pattern == 13 ) lcd_pattern = 1;
    }
    ...
    case 3:
        ...
        lcdPrintf( "03  stop time       %04d mS", i );
        break;
	case 4://クランク時モーター速度
        ...
        lcdPosition( 0, 0 );
                 /* 0123456789abcdef0123456789abcdef 1行16文字 */
        lcdPrintf( "04 Crank Speed      %03d", i );
        break;	
	case 5:
        ...
        lcdPosition( 0, 0 );
                 /* 0123456789abcdef0123456789abcdef 1行16文字 */
        lcdPrintf( "05 Crank handle     %03d", i );
        break;
	case 6://クランク時モーター　OUT
        ...
        lcdPosition( 0, 0 );
                 /* 0123456789abcdef0123456789abcdef 1行16文字 */
        lcdPrintf( "06 Crank motor  OUT   %03d", i );
        break;
	case 7://クランク時モーター　IN
        ...
        lcdPosition( 0, 0 );
                 /* 0123456789abcdef0123456789abcdef 1行16文字 */
        lcdPrintf( "07 Crank motor  IN   %03d", i );
        break;
	...
	case 8:
        ...
        lcdPosition( 0, 0 );
                 /* 0123456789abcdef0123456789abcdef 1行16文字 */
        lcdPrintf( "08 LaneChange   Speed    %3d", i );
        break;
	case 9:
        ...
        lcdPosition( 0, 0 );
                 /* 0123456789abcdef0123456789abcdef 1行16文字 */
        lcdPrintf( "09 LaneChange   L handle   %03d", i );
        break;
	case 10:
        ...
        lcdPosition( 0, 0 );
                 /* 0123456789abcdef0123456789abcdef 1行16文字 */
        lcdPrintf( "10 LaneChange   R handle   %03d", i );
        break;
	case 11:
        ...
        lcdPosition( 0, 0 );
                 /* 0123456789abcdef0123456789abcdef 1行16文字 */
        lcdPrintf( "11 LaneChange   Motor OUT %03d", i );
        break;
	case 12:
        ...
        lcdPosition( 0, 0 );
                 /* 0123456789abcdef0123456789abcdef 1行16文字 */
        lcdPrintf( "12 LaneChange   Motor IN  %03d", i );
        break;
